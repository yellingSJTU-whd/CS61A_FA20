...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        return False
    greatest_common_factor = gcd(player_score, opponent_score)
    if greatest_common_factor < 10:
        return False
    return True
    # END PROBLEM 4a
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    def announce_highest_for_player0(score0, score1):
    ...
    def announce_highest_for_player1(score0, score1):
    ...
    if who == 0:
        return announce_highest_for_player0
    return announce_highest_for_player1
    # END PROBLEM 7
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    bacon_scoring = free_bacon(opponent_score)
    if bacon_scoring >= cutoff:
        return 0
    return num_rolls
    # END PROBLEM 10
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    bacon_scoring = free_bacon(opponent_score)
    if extra_turn(score + bacon_scoring, opponent_score):
        return 0
