...
SELECT a.child as name0, b.child as name1
from parents as a,
     parents as b
...
SELECT 'The two siblings, ' || name0 || ' plus ' || name1 || ' have the same size: ' || a.size as sentence
from siblings,
     size_of_dogs as a,
     size_of_dogs as b
where siblings.name0 = a.name
  and siblings.name1 = b.name
  and a.size = b.size;
