...
def totals_tree(m):
    ...
    root = tree(total_weight(m), [totals_tree(end(left(m))), totals_tree(end(right(m)))])
    return root
...
def replace_leaf(t, find_value, replace_value):
    ...
    replaced_branches = [replace_leaf(branch, find_value, replace_value) for branch in branches(t)]
